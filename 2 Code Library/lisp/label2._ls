...
(load "Original Site Plan Lisp\\Downloaded\\WriteCSV-V1-1");Load CSV writing script by Lee Mac 
(load "Original Site Plan Lisp\\Downloaded\\OutlineObjectsV1-1");Using some document management functions by Lee Mac
(load "Original Site Plan Lisp\\Downloaded\\del-layer")
(load "Original Site Plan Lisp\\colorLines");Load useful functions

;Description:
;Command to run <a href="#helper2">helper2</a>.
(defun C:ROOF ()
	(helper2 "tdsb-smsc-building parapet lines" "ROOF")
)

;Description:
;Label roof parapet lines and canopy lines
