...
;Description:
;Function to find all of the available drive
;Arguments:
;dList: list of drives
;Returns: the list of verified files
...
(defun SelectFiles(filePath Extension verifyDrives)
	...
	;;;--- Load the dialog box
	(setq dcl_id (load_dialog "SELECTFILES"))
